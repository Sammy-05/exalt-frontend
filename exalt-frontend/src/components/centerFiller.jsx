      ...
      <div className="mx-10 text-white absolute w-1/2 md:w-1/3 ml-16 md:ml-48 flex flex-col justify-center h-full">
        ...
        {buttontext ? (
            <div className="pt-10 md:pt-20">
              <button onClick={handleButtonClick} className="font-georgia font-bold text-mobile-p md:text-base hover:bg-violet bg-navyblue text-white rounded-xl px-3 md:px-5 py-2 md:py-2 flex border-2 border-white items-center">
                {buttontext}
                <FontAwesomeIcon
                  icon={faArrowRight}
